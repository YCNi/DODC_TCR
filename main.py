...
from config import odl_keys, link_length, T, K, K_JAM, OD_route, \
    scenario, link_TT, link_count, link_den, inflow, zero_OD, o_splits, FC, FD
...
opt_model(scenario,OD_to_downstream_TT,OD_to_upstream_TT,link_count,link_den,inflow,zero_OD,o_splits,FC,FD,K_JAM)
